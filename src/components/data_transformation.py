...
class DataTranformation:
    ...
    def initiate_data_tranfsormation(self, train_path, test_path):
        try:
            train_df = pd.read_csv(train_path)
            test_df = pd.read_csv(test_path)

            logging.info("read train and test data compeletely")

            logging.info("obtainning a preprocessing object")
